...
const __ds_ns = (window.LionsClubBonnRheinaueDesignSystem_4b530e = window.LionsClubBonnRheinaueDesignSystem_4b530e || {});
...
function Avatar({
  ...
  const cls = ['lc-avatar', `lc-avatar--${size}`, tone !== 'gold' ? `lc-avatar--${tone}` : '', className].filter(Boolean).join(' ');
...
function Button({
  ...
  const Tag = as;
  const cls = ['lc-btn', `lc-btn--${variant}`, `lc-btn--${size}`, fullWidth ? 'lc-btn--full' : '', className].filter(Boolean).join(' ');
...
function Card({
  ...
  const cls = ['lc-card', size === 'lg' ? 'lc-card--lg' : '', flush ? 'lc-card--flush' : '', sunken ? 'lc-card--sunken' : '', interactive ? 'lc-card--interactive' : '', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement(Tag, _extends({
    className: cls
  }, rest), children);
}
...
function IconButton({
  ...
  const cls = ['lc-iconbtn', `lc-iconbtn--${size}`, bordered ? 'lc-iconbtn--bordered' : '', tone === 'primary' ? 'lc-iconbtn--primary' : '', className].filter(Boolean).join(' ');
...
function Tag({
  ...
  const cls = ['lc-tag', outline ? 'lc-tag--outline' : '', tone !== 'neutral' ? `lc-tag--${tone}` : '', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("span", _extends({
    className: cls
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/feedback/HintCard.jsx", error: String((e && e.message) || e) }); }
...
function StatusBadge({
  ...
  if (dotOnly) {
    return /*#__PURE__*/React.createElement("span", _extends({
      className: ['lc-status-dot', `lc-status-dot--${status}`, className].filter(Boolean).join(' '),
...
function AppBar({
  ...
  const cls = ['lc-appbar', bordered ? 'lc-appbar--bordered' : '', center ? 'lc-appbar--center' : '', large ? 'lc-appbar--large' : '', className].filter(Boolean).join(' ');
  ...
  }, title) : null), trailing ? /*#__PURE__*/React.createElement("div", {
...
function ListRow({
  ...
  }, lead) : null, /*#__PURE__*/React.createElement("span", {
  ...
  }, subtitle) : null), date || trailing || chevron ? /*#__PURE__*/React.createElement("span", {
    className: "lc-row__trail"
  }, date ? /*#__PURE__*/React.createElement("span", {
    className: "lc-row__date"
  }, date) : null, trailing, chevron ? /*#__PURE__*/React.createElement("span", {
...
function TabBar({
  ...
  return /*#__PURE__*/React.createElement("nav", {
    ...
    }, active && it.iconActive ? it.iconActive : it.icon), it.badge ? /*#__PURE__*/React.createElement("span", {
...
function AdminScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Clubjahr 2025/26"), /*#__PURE__*/React.createElement("div", {
    className: "admin-head__sub"
  }, events.length, " Termine geplant")), /*#__PURE__*/React.createElement(Button, {
    variant: "secondary",
    size: "sm",
  ...
  }, "Termin")), Object.keys(groups).map(month => /*#__PURE__*/React.createElement("div", {
    key: month
  }, /*#__PURE__*/React.createElement("div", {
    className: "sec-label"
  }, month), /*#__PURE__*/React.createElement(Card, {
    flush: true
  }, groups[month].map((e, i) => /*#__PURE__*/React.createElement("div", {
    key: e.id,
  ...
  }, e.monShort)), /*#__PURE__*/React.createElement("div", {
    ...
    name: "check",
    size: 13
  }), e.yes), /*#__PURE__*/React.createElement("span", {
    ...
    name: "circle-help",
    size: 12
  }), e.open)), /*#__PURE__*/React.createElement(Ic, {
    name: "pencil",
    size: 17,
    ...
    name: "info",
    size: 15
  }), " R\xFCckmeldezahlen sind antippbar \u2014 der Status kann sich im laufenden Prozess noch \xE4ndern. Vorstand & Sekret\xE4r k\xF6nnen Termine anlegen, bearbeiten und R\xFCckmeldungen einsehen."), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 12
    }
  }))));
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/club-app/AdminScreen.jsx", error: String((e && e.message) || e) }); }
...
function NewsScreen() {
  ...
  }, p.role, " \xB7 ", p.time)), /*#__PURE__*/React.createElement(Tag, {
    tone: "blue",
    outline: true
...
function MoreScreen({
  ...
  const lead = n => /*#__PURE__*/React.createElement("span", {
    className: "more__ic"
  }, /*#__PURE__*/React.createElement(Ic, {
    name: n,
    size: 20
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, me.role, " \xB7 Profil bearbeiten")), /*#__PURE__*/React.createElement(Ic, {
    name: "chevron-right",
    size: 20,
    color: "var(--text-muted)"
  })), /*#__PURE__*/React.createElement("div", {
    className: "sec-label"
  }, "Vorstand"), /*#__PURE__*/React.createElement(Card, {
    flush: true
    ...
    className: "sec-label"
  }, "Allgemein"), /*#__PURE__*/React.createElement(Card, {
    flush: true
  }, /*#__PURE__*/React.createElement(ListRow, {
    lead: lead('file-text'),
    title: "Dokumente",
...
function App() {
  ...
  const showResponses = (eventId, status) => setSheet({
    eventId,
    status
  });
  const tabs = [{
  ...
  if (!authed) {
    return /*#__PURE__*/React.createElement(PhoneFrame, null, /*#__PURE__*/React.createElement(LoginScreen, {
      onLogin: () => setAuthed(true)
    }));
  }
  let body;
  if (overlay?.type === 'event') body = /*#__PURE__*/React.createElement(EventDetailScreen, {
    eventId: overlay.id,
    onBack: () => setOverlay(null),
    onResponses: showResponses
  });else if (overlay?.type === 'attendance') body = /*#__PURE__*/React.createElement(AttendanceScreen, {
    onBack: () => setOverlay(null)
  });else if (overlay?.type === 'treasurer') body = /*#__PURE__*/React.createElement(TreasurerScreen, {
    onBack: () => setOverlay(null)
  });else if (overlay?.type === 'admin') body = /*#__PURE__*/React.createElement(AdminScreen, {
    onBack: () => setOverlay(null),
    onOpen: id => setOverlay({
      type: 'event',
      id
    }),
    onResponses: showResponses
  });else if (overlay?.type === 'profile') body = /*#__PURE__*/React.createElement(ProfileScreen, {
    onBack: () => setOverlay(null)
  });else if (tab === 'termine') body = /*#__PURE__*/React.createElement(EventListScreen, {
    onOpen: id => setOverlay({
      type: 'event',
      id
    }),
    onResponses: showResponses
  });else if (tab === 'mitglieder') body = /*#__PURE__*/React.createElement(MembersScreen, {
    onOpen: () => {}
  });else if (tab === 'news') body = /*#__PURE__*/React.createElement(NewsScreen, null);else body = /*#__PURE__*/React.createElement(MoreScreen, {
    onNav: type => setOverlay({
      type
    })
  });
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/club-app/App.jsx", error: String((e && e.message) || e) }); }
...
function AttendanceScreen({
  ...
  }, "Club-Abend"), /*#__PURE__*/React.createElement("div", {
    className: "att-summary__s"
  }, /*#__PURE__*/React.createElement("span", {
    className: "u-mono"
  }, "12.06."), " \xB7 ", /*#__PURE__*/React.createElement("span", {
    className: "u-mono"
  }, "19:00"), " \xB7 Restaurant Rheinblick")), /*#__PURE__*/React.createElement("div", {
  ...
  }, presentCount), /*#__PURE__*/React.createElement("span", null, "/ ", members.length, " da"))))), /*#__PURE__*/React.createElement("div", {
    className: "att-list"
  }, members.map(m => /*#__PURE__*/React.createElement("label", {
    key: m.id,
  ...
  }, present[m.id] ? 'Anwesend' : 'Abwesend')), /*#__PURE__*/React.createElement("input", {
    type: "checkbox",
    className: "att-toggle",
    checked: present[m.id],
    onChange: () => setPresent(p => ({
      ...p,
      [m.id]: !p[m.id]
    }))
  }), /*#__PURE__*/React.createElement("span", {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/club-app/AttendanceScreen.jsx", error: String((e && e.message) || e) }); }
...
function EventDetailScreen({
  ...
  const setAns = (pid, qid, val) => setAnswers(a => ({
    ...a,
    [pid]: {
      ...(a[pid] || {}),
      [qid]: val
  ...
  const renameCompanion = (id, name) => setCompanions(c => c.map(x => x.id === id ? {
    ...x,
    name
  } : x));
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, e.type), /*#__PURE__*/React.createElement("h1", {
    ...
    name: "calendar-days",
    size: 18
  }), /*#__PURE__*/React.createElement("span", null, e.weekday, ", ", e.date, e.month.split(' ')[1], " \xB7 ", /*#__PURE__*/React.createElement("span", {
    className: "u-mono"
    ...
    name: "map-pin",
    size: 18
  }), /*#__PURE__*/React.createElement("span", null, e.location, ", ", e.city)))), /*#__PURE__*/React.createElement("div", {
    className: "screen__pad detail__stack"
  }, /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    className: "detail__statusrow"
  }, /*#__PURE__*/React.createElement("span", {
    className: "detail__statuslabel"
  }, past ? 'Deine Meldung' : 'Dein Status'), /*#__PURE__*/React.createElement(StatusBadge, {
    status: status
  })), /*#__PURE__*/React.createElement("p", {
    className: "detail__desc"
  }, e.desc)), past && e.present != null && /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    className: "att-final"
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, "Anwesenheit erfasst"), /*#__PURE__*/React.createElement("div", {
    className: "att-final__s"
  }, e.present, " von ", e.yes, " Zusagen anwesend")), /*#__PURE__*/React.createElement("span", {
    className: "att-final__n"
  }, e.present))), !past && status !== 'no' && e.companion && /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    className: "detail__qlabel"
  }, /*#__PURE__*/React.createElement(Ic, {
    name: "users",
    size: 17
  }), " Begleitpersonen"), /*#__PURE__*/React.createElement("div", {
    className: "comp-list"
  }, companions.length === 0 && /*#__PURE__*/React.createElement("p", {
    className: "comp-empty"
  }, "Nur ich \u2014 keine Begleitung angemeldet."), companions.map((c, i) => /*#__PURE__*/React.createElement("div", {
    key: c.id,
    className: "comp-row"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    name: "user-plus",
    size: 18
  }), " Begleitperson hinzuf\xFCgen")), !past && status !== 'no' && personQs.length > 0 && persons.map(p => /*#__PURE__*/React.createElement(Card, {
    key: p.id
  }, /*#__PURE__*/React.createElement("div", {
    className: "qf-person"
  }, /*#__PURE__*/React.createElement("span", {
    className: "qf-person__av"
  }, (p.name || '?').trim().charAt(0).toUpperCase() || '?'), /*#__PURE__*/React.createElement("div", {
    className: "qf-person__txt"
  }, /*#__PURE__*/React.createElement("span", {
    className: "qf-person__name"
  }, p.isMe ? me.name : p.name || 'Begleitperson'), /*#__PURE__*/React.createElement("span", {
    className: "qf-person__tag"
  }, p.isMe ? 'Du' : 'Begleitung'))), /*#__PURE__*/React.createElement("div", {
    className: "qf-stack"
  }, personQs.map(q => /*#__PURE__*/React.createElement(QuestionField, {
    key: q.id,
    q: {
      ...q,
      _scope: p.id
  ...
  }))))), !past && status !== 'no' && groupQs.length > 0 && /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    className: "detail__qlabel"
  }, /*#__PURE__*/React.createElement(Ic, {
    name: "clipboard-list",
    size: 17
  }), " Angaben zur Anmeldung"), /*#__PURE__*/React.createElement("div", {
    className: "qf-stack"
  }, groupQs.map(q => /*#__PURE__*/React.createElement(QuestionField, {
    key: q.id,
    q: {
      ...q,
      _scope: 'group'
  ...
  }, past ? 'Finale Rückmeldungen' : 'Meldungen'), /*#__PURE__*/React.createElement(Card, {
    flush: true
  }, [{
    k: 'yes',
    icon: 'check',
  ...
  }, r.n), /*#__PURE__*/React.createElement(Ic, {
    name: "chevron-right",
    size: 18,
    color: "var(--text-muted)"
  })))), /*#__PURE__*/React.createElement("div", {
    ...
    name: "lock",
    size: 16
  }), " Vergangener Termin \u2014 R\xFCckmeldung geschlossen") : /*#__PURE__*/React.createElement(React.Fragment, null, status === 'open' && /*#__PURE__*/React.createElement("div", {
    className: "rsvp-hint"
  }, /*#__PURE__*/React.createElement(Ic, {
    name: "circle-help",
    size: 15
  }), " Noch keine R\xFCckmeldung \u2014 bitte zu- oder absagen"), /*#__PURE__*/React.createElement("div", {
    className: "rsvp",
    role: "group",
    ...
    name: "check",
    size: 20
  }), " Zusagen"), /*#__PURE__*/React.createElement("button", {
    type: "button",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/club-app/EventDetailScreen.jsx", error: String((e && e.message) || e) }); }
...
function ResponseCounts({
  ...
  return /*#__PURE__*/React.createElement("span", {
    ...
    name: "x",
    size: 14
  }), e.no), /*#__PURE__*/React.createElement("span", {
    className: "rc__i rc__i--open",
    role: "button",
    tabIndex: 0,
    title: "Keine Meldung anzeigen",
...
function EventCard({
  ...
  return /*#__PURE__*/React.createElement("button", {
  ...
  }, e.weekday), /*#__PURE__*/React.createElement("span", {
    ...
    name: "map-pin",
    size: 14
  }), " ", e.location, " \xB7 ", /*#__PURE__*/React.createElement("span", {
    className: "u-mono"
  }, e.time)), /*#__PURE__*/React.createElement("div", {
  ...
  }, e.type), /*#__PURE__*/React.createElement(StatusBadge, {
    status: e.status
  })), past && e.present != null ? /*#__PURE__*/React.createElement("span", {
    className: "ev-card__att",
    title: "Erfasste Anwesenheit"
  }, /*#__PURE__*/React.createElement(Ic, {
    name: "user-check",
    size: 14
  }), " ", e.present, " anwesend") : /*#__PURE__*/React.createElement(ResponseCounts, {
    e: e,
    onPick: onResponses
  }))));
}
function EventListScreen({
  ...
  const list = events.filter(e => e.phase === phase).sort((a, b) => phase === 'upcoming' ? a.iso.localeCompare(b.iso) : b.iso.localeCompare(a.iso));
  const groups = [];
  const seen = {};
  list.forEach(e => {
    if (!seen[e.month]) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    events: events,
    onOpen: onOpen
  })) : /*#__PURE__*/React.createElement(React.Fragment, null, groups.map(([month, items]) => /*#__PURE__*/React.createElement("div", {
    key: month,
    className: "ev-group"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "card-list"
  }, items.map(e => /*#__PURE__*/React.createElement(EventCard, {
    key: e.id,
    e: e,
    onOpen: onOpen,
    ...
    className: "ev-empty"
  }, "Keine ", phase === 'past' ? 'vergangenen' : 'anstehenden', " Termine.")), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 12
    }
  })));
...
function CalendarView({
  ...
  }, MONTHS_DE[cursor.m], " ", cursor.y), /*#__PURE__*/React.createElement("button", {
    className: "cal-nav__btn",
  ...
  }, monthEvents.length === 0 && /*#__PURE__*/React.createElement("div", {
    className: "ev-empty",
    style: {
      padding: '20px 0'
    }
  }, "Keine Termine in diesem Monat."), monthEvents.map(e => /*#__PURE__*/React.createElement("button", {
    key: e.id,
    className: "ev-mini",
    onClick: () => onOpen(e.id)
  ...
  }, e.title), e.phase === 'past' && /*#__PURE__*/React.createElement(Ic, {
    name: "lock",
    size: 14,
    color: "var(--text-muted)"
  }), /*#__PURE__*/React.createElement(Ic, {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/club-app/EventListScreen.jsx", error: String((e && e.message) || e) }); }
...
function LoginScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    src: window.__resources && window.__resources.lionsEmblem || '../../assets/lions-emblem.png',
    alt: "Lions Clubs International Emblem"
  }), /*#__PURE__*/React.createElement("div", {
    className: "brand__name"
  }, "Lions Club", /*#__PURE__*/React.createElement("br", null), "Bonn-Rheinaue"), /*#__PURE__*/React.createElement("div", {
    className: "brand__sub"
  }, "We Serve"))), step === 'email' ? /*#__PURE__*/React.createElement("div", {
    className: "login__card"
  }, /*#__PURE__*/React.createElement("h1", {
    className: "login__h"
  }, "Willkommen zur\xFCck"), /*#__PURE__*/React.createElement("p", {
    className: "login__p"
  }, "Melde dich mit deiner E-Mail-Adresse an. Wir senden dir einen 6-stelligen Code."), /*#__PURE__*/React.createElement(Input, {
    label: "E-Mail",
    type: "email",
    icon: /*#__PURE__*/React.createElement(Ic, {
      name: "mail",
  ...
  }, "Code anfordern")) : /*#__PURE__*/React.createElement("div", {
    className: "login__card"
  }, /*#__PURE__*/React.createElement("button", {
    ...
    name: "chevron-left",
    size: 18
  }), " Zur\xFCck"), /*#__PURE__*/React.createElement("h1", {
    className: "login__h"
  }, "Code eingeben"), /*#__PURE__*/React.createElement("p", {
    className: "login__p"
  }, "Wir haben einen Code an", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", null, email), " gesendet."), /*#__PURE__*/React.createElement(OtpInput, {
    value: code,
    onChange: setCode
  }), /*#__PURE__*/React.createElement(Button, {
    variant: "primary",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/club-app/LoginScreen.jsx", error: String((e && e.message) || e) }); }
...
function MembersScreen({
  ...
  }, m.role, m.status === 'Ehrenmitglied' && /*#__PURE__*/React.createElement(Tag, {
    tone: "gold",
    dot: true
  }, "Ehrenmitglied"), m.status === 'inaktiv' && /*#__PURE__*/React.createElement(Tag, {
    outline: true
  }, "inaktiv"))), /*#__PURE__*/React.createElement("div", {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/club-app/MembersScreen.jsx", error: String((e && e.message) || e) }); }
...
function ProfileScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, me.role, " \xB7 seit 2014")), /*#__PURE__*/React.createElement("div", {
    className: "screen__pad detail__stack"
  }, /*#__PURE__*/React.createElement("div", {
    className: "sec-label"
  }, "Kontaktdaten"), /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "sec-label"
  }, "Partner/in"), /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    className: "form-stack"
  }, /*#__PURE__*/React.createElement(Input, {
    label: "Name",
    ...
    className: "sec-label"
  }, "Benachrichtigungen"), /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    className: "switch-stack"
  }, /*#__PURE__*/React.createElement("div", {
    className: "switch-row"
  }, /*#__PURE__*/React.createElement("span", null, "Push-Erinnerungen"), /*#__PURE__*/React.createElement(Switch, {
    defaultChecked: true
  })), /*#__PURE__*/React.createElement("div", {
    className: "switch-row"
  }, /*#__PURE__*/React.createElement("span", null, "E-Mail-Fallback"), /*#__PURE__*/React.createElement(Switch, {
    defaultChecked: true
  })), /*#__PURE__*/React.createElement("div", {
    className: "switch-row"
  }, /*#__PURE__*/React.createElement("span", null, "Geburtstags-Hinweise"), /*#__PURE__*/React.createElement(Switch, null)))), edit && /*#__PURE__*/React.createElement(Button, {
    variant: "primary",
    size: "lg",
    fullWidth: true,
    onClick: () => setEdit(false)
  }, "\xC4nderungen speichern"), /*#__PURE__*/React.createElement("button", {
    className: "logout"
  }, /*#__PURE__*/React.createElement(Ic, {
    name: "log-out",
    size: 18
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/club-app/ProfileScreen.jsx", error: String((e && e.message) || e) }); }
...
function QuestionField({
  ...
  if (q.kind === 'single') {
    ...
    }, q.options.map(opt => /*#__PURE__*/React.createElement(Checkbox, {
      key: opt,
      radio: true,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    name: q.icon,
    size: 16
  })) : null, /*#__PURE__*/React.createElement("span", null, q.label, q.required ? /*#__PURE__*/React.createElement("span", {
    className: "qf__req"
  }, "*") : null)), control);
}
window.QuestionField = QuestionField;
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/club-app/QuestionField.jsx", error: String((e && e.message) || e) }); }
...
function ResponseSheet({
  ...
  const groups = ev ? window.LC_DATA.responsesFor(ev) : {
    yes: [],
    no: [],
    open: []
  };
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Meldungen"), /*#__PURE__*/React.createElement("div", {
    className: "rs__title"
  }, ev ? ev.title : '')), /*#__PURE__*/React.createElement("button", {
    className: "rs__close",
    "aria-label": "Schlie\xDFen",
    onClick: onClose
  }, /*#__PURE__*/React.createElement(Ic, {
    ...
    className: "rs__list"
  }, list.map((m, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    className: "rs__row"
  }, /*#__PURE__*/React.createElement(Avatar, {
    name: m.name,
    ...
    className: "rs__role"
  }, m.role)), m.companion ? /*#__PURE__*/React.createElement("span", {
    className: "rs__companion"
  }, /*#__PURE__*/React.createElement(Ic, {
    name: "user-plus",
    size: 14
  }), " +1") : null)), list.length === 0 && /*#__PURE__*/React.createElement("div", {
    className: "rs__empty"
  }, "Niemand in dieser Gruppe."), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 8
    }
  }))));
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/club-app/ResponseSheet.jsx", error: String((e && e.message) || e) }); }
...
function TreasurerScreen({
  ...
  }, "Abwesenheiten"), /*#__PURE__*/React.createElement("div", {
    className: "treas-stat__n"
  }, totalAbsences)), /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    className: "treas-stat__l"
  }, "Summe \xB7 ", euro(rate), "/Stk."), /*#__PURE__*/React.createElement("div", {
    className: "treas-stat__n u-mono",
    style: {
      color: 'var(--gold-700)'
    }
  }, euro(totalSum)))), /*#__PURE__*/React.createElement("div", {
    className: "sec-label"
  }, "Je Mitglied"), /*#__PURE__*/React.createElement(Card, {
    flush: true
  ...
  }, r.count, "\xD7"), /*#__PURE__*/React.createElement("span", {
    className: "treas-row__sum u-mono"
  }, euro(r.count * rate))))), /*#__PURE__*/React.createElement("div", {
    className: "treas-note"
  }, /*#__PURE__*/React.createElement(Ic, {
    name: "info",
    size: 15
  }), " Die App erfasst nur Abwesenheiten. Die Buchung erfolgt extern durch den Schatzmeister."), /*#__PURE__*/React.createElement("div", {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/club-app/TreasurerScreen.jsx", error: String((e && e.message) || e) }); }
...
window.LC_DATA.responsesFor = function (ev) {
  ...
  const tag = (arr, status) => arr.map((m, i) => ({
    ...m,
    status,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/club-app/data.js", error: String((e && e.message) || e) }); }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/club-app/helpers.jsx", error: String((e && e.message) || e) }); }
