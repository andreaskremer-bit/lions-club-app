...
**M0–M6 + P1 + P2 + P2.1 + P4 vollständig & LIVE (M6: Dokumente, News, Galerie-Link; Versand NICHT scharfgestellt — Geheim-Phase), Prototyp LIVE.**
...
**Offener Backlog:** P3 Lions-Deutschland-Export (`export_lions` existiert, Feature fehlt) — **AUF HOLD** (Club klärt Bedarf intern) · großer Block **Design „Lions 2.0"** (volle design-referenz-Treue + echte Lions-Icons, Logo ist nutzbar; TabBar/IA). (P4 Benachrichtigungs-Präferenzen erledigt.)
